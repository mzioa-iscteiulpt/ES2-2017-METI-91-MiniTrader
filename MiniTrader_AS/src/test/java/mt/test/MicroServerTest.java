...
import mt.server.MicroServer_AS;
...
public class MicroServerTest {
	...
	public void testStart() throws Exception {
		...
		verify(serverComm, atLeastOnce()).sendOrder("userB", Order.createSellOrder("userA", "MSFT", 20, 20.0) );
		verify(serverComm, atLeastOnce()).sendOrder("userB", Order.createBuyOrder("userB", "MSFT", 1, 21.0) );
	}
