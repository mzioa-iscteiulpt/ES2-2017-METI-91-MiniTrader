...
public final class CommUtils {
	...
	/**
	 * This method is used to create a warning client side message which is sent to the client
	 * @param WarningMessage
	 * 			Warning Message to be sent to the client.
	 * @return An object representing an warning client side message 			
	 */
	public static ClientSideMessage createWarningMessage(String WarningMessage){
		return new ClientSideMessageImpl(ClientSideMessage.Type.WARNING, WarningMessage);
	}
